...
def student_menu(app):
    while True:
        ...
        if choice == '1':
            ...
            student, elapsed = app.search_student_by_name(first_name, last_name)
            ...
            asc = input("Sort student records by email - Press [a] for ascending or [d] for descending: ").strip().lower() == 'a'
            ...
            asc = input("Sort student records by marks - Press [a] for ascending order or [d] for descending order: ").strip().lower() == 'a'
    ...
    while True:
        ...
        if choice == '1':
            ...
            try:
                ...
                course = Course(cid, name, credits, desc)
            ...
            if app.delete_new_course(cid):
                print("Course has deleted successfully.")
            else:
            ...
            try:    
                ...
                credits = input("Enter new course credits or press enter to skip: ").strip()
                ...
                if app.modify_course(cid, **update_data):
...
def grades_menu(app):
    while True:
        print("""
            ...
            2. Average marks for a course
            3. Median marks for a course
            0. Back
            """)
        choice = input("Select an option: ").strip()
